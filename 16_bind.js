describe ("Bind", function() {
  ...
  it ("set this", function() {
    ...
    let o1 = {};
    let binded = f.bind(this,o1);    // create a new method by calling 'bind' on f, setting this to o1

    binded()

    expect(o1.prop).toBeUndefined();
    expect(o1.prop).toEqual(undefined);
